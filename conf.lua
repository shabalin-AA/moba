function love.conf(t)
    ...
    t.window.title = "Moba"         -- The window title (string)
    ...
    t.window.minwidth = 40               -- Minimum window width if the window is resizable (number)
    t.window.minheight = 40              -- Minimum window height if the window is resizable (number)
